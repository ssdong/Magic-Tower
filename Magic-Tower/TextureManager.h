...
/* 
   This texture manager is dealing with various kinds of rendering tasks
*/
...
public:
	...
	void drawStatus( std::string heroID, 
		             std::string itemID, 
	...
	// Draw fight!
	void drawFight( std::string heroID, 
		            std::string enemyID, 
				    SDLGameObject* player, 
				    SDLGameObject* enemy, 
				    SDL_Renderer* pRenderer, 
	...
	void drawMessage( std::string messageType,
		              Position& position, 
	...
	// Make black screen when switching floors
	void changeFloor( SDL_Renderer* pRenderer, 
		              TTF_Font* font, 
					  int floor );
};
